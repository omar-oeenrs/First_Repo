...
int main() {
    // Example usage
    Employee driver("John Doe", 30, "E12345");

    // Motor with 2 wheels
    Motor myMotor(10.0, 70.0, 2022, "Black", 100, false, driver);
    
    // Car with 4 wheels
    Car myCar(50.0, 90.0, 2020, "Red", 120, true, driver, 4);
    
    // Bus with 6 wheels
    Bus myBus(80.0, 85.0, 2018, "Blue", 80, false, driver, 3);
    //myBus.start();
    myBus.accelerate(13);
    //myBus.brake(20);
    //myBus.stop();
    cout << "Bus has " << myBus.getWheels().size() << " wheels." << endl << endl;
